...
import ImressionsWidgetType from '../../../api/types/ImpressionsWidgetType';
...
function Impressions() {
	...
	const { data: widget } = useGetWidget<ImressionsWidgetType>('impressions');
	...
	return (
		<Paper className="flex flex-auto flex-col overflow-hidden rounded-xl shadow-sm">
			<div className="m-4 mb-0 flex items-start justify-between">
				<Typography className="truncate text-lg leading-6 font-medium tracking-tight">Impressions</Typography>
				<div className="ml-2">
					<Chip
						size="small"
